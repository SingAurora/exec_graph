...
func (repository *Repository) ListActivities(ctx context.Context, userID uint64, start, end time.Time) ([]applicationworkoverview.ActivityRecord, error) {
	var activities []applicationworkoverview.ActivityRecord
	...
	var records []applicationworkoverview.ActivityRecord
...
func (repository *Repository) ListReviews(ctx context.Context, userID uint64, start, end time.Time) ([]applicationworkoverview.ReviewRecord, error) {
	var reviews []applicationworkoverview.ReviewRecord
...
func (repository *Repository) SaveReview(ctx context.Context, userID uint64, date time.Time, content applicationworkoverview.ReviewContent, aiConfig string, reviewID string) error {
