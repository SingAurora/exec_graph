// Package collaboration contains GORM persistence for collaboration calls, submissions, and adoption.
...
func (repository *Repository) Rows(ctx context.Context, query string, args ...any) (*sql.Rows, error) {
	if repository == nil || repository.orm == nil {
		return nil, fmt.Errorf("collaboration repository is not configured")
	}
...
func (repository *Repository) Execute(ctx context.Context, query string, args ...any) (Result, error) {
	if repository == nil || repository.orm == nil {
		return Result{}, fmt.Errorf("collaboration repository is not configured")
	}
